"""Patch the retired Dify reading archive compatibility workflow.

This workflow is historical/compatibility evidence only. Current first-create
and explicit rebuild of summary.md are owned by the backend summary archive
pipeline, not by this Dify app.
